...
```{r}
# Now we can make a MA plot 
#What is the relationship between Log Fold Change and magnitude of expression 

plotMA(resG1_CvT, ylim=c(-5,5))

```
Time to make a volcano plot 
...
## Lets make plots to show CvTs across generations
```{r}
#Gen1
resG1_CvT <- results(dds, contrast=c("group","controlG1","treatmentG1"), alpha = 0.05)
...
Now its time to make some Euler Plots 
We can also make Venn Diagrams 
```{r}
...
# Number unique genes expressed in each generation 
...
fit1 <- euler(c("G1" = 288, "G2" = 4860, "G3" =882 , "G1&G2" = 214, "G1&G3" = 58, "G2&G3" =281 , "G1&G2&G3" =13 ))
