...
Time for some soft thresholding
```{r}
...
plotDendroAndColors(bwnet$dendrograms[[1]], cbind(bwnet$unmergedColors, bwnet$colors),
                    ...
                    guideHang = 0.05)
```
Test for correlation between eigengene and trait data 
```{r}
...
```
Plot eigengene values by treatment and line condition 
...
Lets see what these highly correlated genes are! GO analysis baby
