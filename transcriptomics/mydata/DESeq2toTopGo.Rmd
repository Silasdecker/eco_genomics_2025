...
# Import libs and data and run DESeq2 to generate the results for testing functional enrichment 
...
#Can we output the entrichment results from TopGO and try ReviGO like was in the paper from class?
