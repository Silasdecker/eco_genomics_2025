...
```
### Pretty crummy mapping, but this is using a different cultivar of chrysanthenum so proceed we shall! 
...
### Run Deseq2 - made a new .Rmd file to run DESeq2 called DESEQ2_Chrys_soil_v_hydro that lives in: 
