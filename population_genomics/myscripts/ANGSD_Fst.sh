...
#SBATCH --output=/users/s/m/smdecker/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
#This will use ANGSD to estimate Fst between red spruce and black spruce from outside the range 


# Path to the `population_genomics` folder in your repo

REPO="/users/s/m/smdecker/projects/eco_genomics_2025/population_genomics"
...
# Step 4 (optional): Calculate the average Fst in sliding windows
realSFS fst stats2 \
${REPO}/mydata/ANGSD/${MYRSPOP}_${MYBSPOP}.fst.idx \
-win 50000 \
-step 50000 \
